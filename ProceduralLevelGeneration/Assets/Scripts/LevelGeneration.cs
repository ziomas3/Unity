...
public class LevelGeneration : MonoBehaviour {
	...
	void Start () {
        ...
        treeGeneration.GenerateTrees(levelWidthInTiles*tileWidthInVertices,levelDepthInTiles*tileDepthInVertices,distanceBetweenVertices, levelData);
		//TileCoordinate tileCoordinate = levelData.ConvertToTileCoordinate (21, 21);
		//levelData.tilesData [tileCoordinate.tileXIndex, tileCoordinate.tileZIndex].texture.SetPixel (tileCoordinate.coordinateXIndex, tileCoordinate.coordinateZIndex, Color.black);
		//levelData.tilesData [tileCoordinate.tileXIndex, tileCoordinate.tileZIndex].texture.Apply ();
	}
